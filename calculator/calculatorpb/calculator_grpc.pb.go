...
type CalculatorServiceClient interface {
	...
	SqaureRoot(ctx context.Context, in *SqaureRootRequest, opts ...grpc.CallOption) (*SqaureRootResponse, error)
}
...
func (c *calculatorServiceClient) SqaureRoot(ctx context.Context, in *SqaureRootRequest, opts ...grpc.CallOption) (*SqaureRootResponse, error) {
	out := new(SqaureRootResponse)
	err := c.cc.Invoke(ctx, "/calculator.CalculatorService/SqaureRoot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculatorServiceServer interface {
	...
	// this RPC will throw an exception if the sent number is negative
	// The error being sent is of type INVALID_ARGUMENT
	SqaureRoot(context.Context, *SqaureRootRequest) (*SqaureRootResponse, error)
...
func (UnimplementedCalculatorServiceServer) SqaureRoot(context.Context, *SqaureRootRequest) (*SqaureRootResponse, error) {
...
func _CalculatorService_SqaureRoot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SqaureRootRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalculatorServiceServer).SqaureRoot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculator.CalculatorService/SqaureRoot",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServiceServer).SqaureRoot(ctx, req.(*SqaureRootRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _CalculatorService_SqaureRoot_Handler,
		},
	},
